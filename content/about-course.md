...
- Formal introduction to digital stewardship methodologies (digital curation and digital preservation)
- Fluency in collecting, standardizing, and structuring archival materials to be used as research data
- Designing and implementing a humanities-based research data management plan
- Experience working as a team and developing communication skills related to a on a technology project
- Using technology platforms, GitHub and CollectionBuilder, that make digital collections publicly available online

# Acquired Skills
- Ability to create and follow a digital collections data management plan
- Ability to apply information professional best practices and standards to digital files and metadata for digital collections curation and preservation
- Ability to structure metadata using spreadsheets and making them interoperable
- Ability to evaluate historical materials and other resources using best judgements about United States copyright, fair use, and Creative Commons
- Ability to find and select research materials to reuse within a thematic digital collection
- Ability to publish a website using GitHub Pages and the Jekyll theme, CollectionBuilder
...
If you have questions about accessing and using Canvas, visit the Canvas support page. Canvas and Technology Support also is available by phone (541-346-4357) or live chat:  

If you face Internet access challenges, know that some companies are offering free access during this challenging time. To learn more about options visit Information Services’ web page on going remote. 
...
The list below identifies tools and platforms that are required for class.
...
- Writing and Coding: Visual Studio Code, DropBox Paper, DMP Tool
- Cataloging: Microsoft Excel
- File Formatting and Manipulation: Adobe Photoshop, GIMP, Adobe Premier, iMovie, Handbrake, Adobe Acrobat, Audacity
- Team Communications: MS Teams, UO E-Mail
